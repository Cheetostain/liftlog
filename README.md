...
## Features
- Two program modes: Standard (no BJJ) and BJJ Mode (rolls 3x/wk). Assumes you're a natty bodybuilder with 8+ hours sleep, maintenance calories, and 0.7g protein per lb bodyweight.
